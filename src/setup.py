...
__version__ = "0.3.0"  # Hardcode the version

# Use relative path for README
readme_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "README.md")
with open(readme_path, "r") as fh:
    long_description = fh.read()

setuptools.setup(
    name="stretch",  # Changed to match your import namespace
    version=__version__,
    ...
    packages=setuptools.find_packages(),  # This should find the 'stretch' package
