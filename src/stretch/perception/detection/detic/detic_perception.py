...
from stretch.perception.detection.detic.Detic.detic.config import add_detic_config  # noqa: E402
...
class DeticPerception(PerceptionModule):
    def __init__(
        ...
        self.logger.info(f"[Detic Init] Received vocabulary arg: '{vocabulary}'")
        self.logger.info(f"[Detic Init] Parsed args.vocabulary: '{args.vocabulary}'")
