...
class ClipEncoder(BaseImageTextEncoder):
    ...
    def __init__(self, version="ViT-L/14@336px", device: Optional[str] = None):
        if device is None:
    ...
    def encode_image(self, image: Union[torch.tensor, np.ndarray, Image.Image]) -> torch.Tensor:
        ...
        if isinstance(image, torch.Tensor):
            ...
            raise TypeError("Unsupported image type for CLIP encoding. Use Tensor, ndarray, or PIL Image.")
